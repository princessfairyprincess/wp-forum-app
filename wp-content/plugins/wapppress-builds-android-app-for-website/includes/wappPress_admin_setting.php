						...
						<div class="setting-form">
							...
							<div class="supportForms_input">
								...
								<p>
									...
									<input style='width:0% !important' type="radio"  name='custom_launcher_logo' id='custom_launcher_logo1' onclick='return show_launcher_logo_form(0);' checked='checked' value='0'/>Upload Launcher Icon&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<div class="supportForms_input">
								...
								<p>
									...
									<input style='width:0% !important' type="radio" name='custom_splash_logo' id='custom_splash_logo1'  onclick='return show_splash_screen_logo_form(0);' checked='checked' value='0'/>Upload Splash Screen&nbsp;&nbsp;&nbsp;&nbsp;
