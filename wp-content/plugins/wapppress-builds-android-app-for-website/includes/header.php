		...
		<div class="inner-header">
			...
			<div class="right-header">
				<div class="navigation">
					<ul>
						<li <?php if(isset($_GET['page']) && $_GET['page']=='wapppresssettings'){ echo 'class="active"'; } ?>><a href="<?php echo admin_url('admin.php?page=wapppresssettings'); ?>" >Settings & Build App </a></li>
						<li <?php if(isset($_GET['page']) && $_GET['page']=='wapppresssettings#bulid'){ echo 'class="active"'; } ?>><a  href="<?php echo admin_url('admin.php?page=wapppresssettings#bulid'); ?>" >Build Android App </a></li>						
