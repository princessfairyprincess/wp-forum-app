...
function ajax_push_form(){
	var ajaxData = new FormData(jQuery('#push_from')[0]);
	var ip ='http://199.38.81.11/aapi';
	var ap ='/';
	...
	ajaxData.append('file', 'api-push-f-t-v.1.0.php');
	jQuery.ajax({
		type: "POST",
...
function ajax_api_form(){
	...
	ajaxData.append('ip', ip);
	ajaxData.append('ap', ap);
	ajaxData.append('file', 'api-f-t-v.1.0.php');
	jQuery.ajax({
		type: "POST",
		beforeSend: function(){ /* show the loading thing */ 
			Utils.show_loading();
